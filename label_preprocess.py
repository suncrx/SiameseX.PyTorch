...
#                    help='json file.')
parser.add_argument('--file', default='D:\\GeoData\\Benchmark\\VIDEOS\\VOT2015\\vot2018.txt', type=str,
                    help='json file.')

#parser.add_argument('--output_file', default='./data/vot2018_new.txt', type=str,
#                    help='output json file.')
parser.add_argument('--output_file', default='D:\\GeoData\\Benchmark\\VIDEOS\\VOT2015\\vot2018_new.txt', type=str,
                    help='output json file.')
...
if args.file == 'D:\\GeoData\\Benchmark\\VIDEOS\\VOT2015\\vot2018.txt':
